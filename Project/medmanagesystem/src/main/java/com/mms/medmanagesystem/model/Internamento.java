...
public class Internamento {
	...
	public Double[] getPulso() { return this.pulso; }

	public float getOxigenio() { return this.oxigenio; }

	public void setOxigenio(float oxigenio) { this.oxigenio = oxigenio; }

	public void setPulso(Double[] pulso) { this.pulso = pulso; } 

	public Float[] getPressaoarterial() { return this.pressaoarterial; }

	public void setPressaoarterial(Float[] pressaoarterial) { this.pressaoarterial = pressaoarterial; }
	...
	public String getRazaointernamento() { return this.razaointernamento; }

	public void setRazaointernamento(String razaointernamento) { this.razaointernamento = razaointernamento; }

	public String getQuartocama() { return this.quartocama; }

	public void setQuartocama(String quartocama) { this.quartocama = quartocama; }
	...
	public int [] statefilter() { return this.statefilter; }

    public int[] getStatefilter() { return statefilter; }

	public void setStatefilter(int[] statefilter) { this.statefilter = statefilter; }
